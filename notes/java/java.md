1. [基础类型](#基础类型)
	1. [Literal number (字面值)](#literal-number-字面值)
	1. [char (字符类型)](#char-字符类型)
	1. [格式化](#格式化)
	1. [有符号数转换无符号数](#有符号数转换无符号数)
	1. [字符串、数值转换](#字符串数值转换)
1. [Package](#package)
	1. [import 关键字](#import-关键字)
	1. [import static 语法](#import-static-语法)
	1. [实例](#实例)
	1. [引用依赖](#引用依赖)
1. [Container (容器)](#container-容器)
1. [Enum (枚举)](#enum-枚举)
1. [浅复制与深复制](#浅复制与深复制)
	1. [浅复制](#浅复制)
	1. [深复制](#深复制)
1. [泛型方法](#泛型方法)
1. [Nested Classes (嵌套类)](#nested-classes-嵌套类)
1. [并发编程](#并发编程)
	1. [Thread / Runnable](#thread--runnable)
	1. [synchronized 关键字](#synchronized-关键字)
	1. [Executor 框架](#executor-框架)
1. [Annotation (注解)](#annotation-注解)
	1. [内置注解](#内置注解)
	1. [元注解](#元注解)
	1. [自定义注解](#自定义注解)
1. [*Reflection* (反射)](#reflection-反射)
	1. [反射机制的相关类型](#反射机制的相关类型)
	1. [Class 类型](#class-类型)
	1. [反射获取成员信息](#反射获取成员信息)
	1. [反射构建实例](#反射构建实例)
	1. [反射调用对象方法](#反射调用对象方法)
	1. [反射修改字段](#反射修改字段)
	1. [反射判定继承关系](#反射判定继承关系)
	1. [ClassLoader (类加载器)](#classloader-类加载器)
1. [动态代理](#动态代理)
	1. [代理模式](#代理模式)
	1. [实例](#实例)
1. [Default Method (接口默认方法)](#default-method-接口默认方法)
1. [Lambda](#lambda)
	1. [实现函数式接口](#实现函数式接口)
	1. [一般用法](#一般用法)
	1. [Method Reference (方法引用)](#method-reference-方法引用)
	1. [标准库中的函数式接口 (java.util.function)](#标准库中的函数式接口-javautilfunction)
1. [JDBC](#jdbc)
	1. [连接数据库](#连接数据库)
	1. [数据库操作](#数据库操作)
	1. [获取时间](#获取时间)
		1. [与 *Access* 数据库交互](#与-access-数据库交互)
1. [Eclipse 使用注记](#eclipse-使用注记)
	1. [Marketplace](#marketplace)
	1. [查看源码](#查看源码)
	1. [编辑器自动换行](#编辑器自动换行)
1. [IntelliJ IDEA 使用注记](#intellij-idea-使用注记)
	1. [显示行号和不可见空白](#显示行号和不可见空白)
	1. [列边界提示](#列边界提示)
	1. [缩进](#缩进)
	1. [包路径折叠](#包路径折叠)
	1. [其它常用选项](#其它常用选项)
	...
	1. [多模块项目](#多模块项目)
1. [常见问题记录](#常见问题记录)
	1. [String.split() 方法](#stringsplit-方法)
	1. [String.format() 方法](#stringformat-方法)
	1. [查询 OS 信息](#查询-os-信息)
	1. [java.lang.UnsatisfiedLinkError: */jre/lib/amd64/libawt_xawt.so: libXrender.so.1: cannot open shared object file: No such file or directory](#javalangunsatisfiedlinkerror-jrelibamd64libawt_xawtso-libxrenderso1-cannot-open-shared-object-file-no-such-file-or-directory)
	1. [java.lang.UnsatisfiedLinkError: */jre/lib/amd64/libawt_xawt.so: libXtst.so.6: cannot open shared object file: No such file or directory](#javalangunsatisfiedlinkerror-jrelibamd64libawt_xawtso-libxtstso6-cannot-open-shared-object-file-no-such-file-or-directory)
