...
输出结果：(gcc 4.9.1 && ArchLinux x86\_64)
`8 5`
...
输出结果：(VS2013 && Windows 8.1 x86\_64)
`9.900000 b 888`
...
输出结果为：
1 1	(gcc 4.9.2 && ArchLinux x86\_64)
0 1	(clang 3.5.1 && ArchLinux x86\_64)
...
输出结果：(gcc 4.9.2 && ArchLinux x86\_64)
0x9
2, 3
...
输出结果(gcc 5.2.0 && ArchLinux x86\_64)：
Use int as args: 100
...
输出结果(VS 2015 && Windows10 x86\_64)：
...
运行结果(gcc 5.4.0 && ArchLinux x86\_64)：
`First`
`Call func()`
`Second`
...
运行结果(gcc 5.3.0 && ArchLinux x86\_64)：
`First`
`^CDeal signal!`
`Second`
`^C^C^C^C`
